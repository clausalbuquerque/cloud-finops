...
/**
 * Consumption record entity mirroring the shared database schema (FOCUS-aligned).
 *
 * This is a local copy for TypeORM registration within this service.
 * The canonical definition lives in `database/src/entities/consumption-record.entity.ts`.
...
export class ConsumptionRecordEntity {
  ...
  @ManyToOne(() => ResourceGroupEntity, (rg) => rg.consumptionRecords, {
    onDelete: 'CASCADE',
  })
